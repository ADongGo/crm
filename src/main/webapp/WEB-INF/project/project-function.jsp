...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12" background="${pageContext.request.contextPath}/resources/skin/images/tbg.gif">&nbsp;功能列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td>2015-02-03</td>
	<td>2015-06-03</td>
	<td><a href="${pageContext.request.contextPath}/project/project-function-edit">编辑</a> | <a href="${pageContext.request.contextPath}/project/project-function-look">查看详情</a></td>
</tr>
