...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12" background="${pageContext.request.contextPath}/resources/skin/images/tbg.gif">&nbsp;编辑项目信息&nbsp;</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input  value="${project.customer.comname}"/>
		<input name="pid" type="hidden" value="${project.customerId}">
	</td>
</tr>
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		...
		<input name="empFk" type="hidden" value="${project.empFk}">
	</td>
</tr>
<tr >
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input value="<fmt:formatDate value="${project.endtime}" pattern="yyyy-MM-dd" />"/>
	</td>
</tr>
...
<td height="28" colspan=4 align=center>
	&nbsp;
	<a href="${pageContext.request.contextPath}/project/saveProjectEdit" class="coolbg">保存</a>
