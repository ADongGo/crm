...
<title>top</title>
<link href="${pageContext.request.contextPath}/resources/skin/css/base.css" rel="stylesheet" type="text/css">
...
{
  text-align:center;
	background:url(${pageContext.request.contextPath}/resources/skin/images/frame/topitembg.gif) 0px 3px no-repeat;
	width:82px;
	height:26px;
	line-height:28px;
}
...
<body bgColor='#ffffff'>
<table width="100%" border="0" cellpadding="0" cellspacing="0" background="${pageContext.request.contextPath}/resources/skin/images/frame/topbg.gif">
  <tr>
    <td width='20%' height="60"><img src="${pageContext.request.contextPath}/resources/skin/images/frame/logo.gif" /></td>
    <td width='80%' align="right" valign="bottom">
    	<table width="750" border="0" cellspacing="0" cellpadding="0">
      <tr>
      <td align="right" height="26" style="padding-right:10px;line-height:26px;">
        	您好：<span style="color:red" >${sessionScope.activeUser.ename}</span>，欢迎使用项目平台管理系统！
        	
        	[<a href="${pageContext.request.contextPath}/main/index" target="_top">主页</a>]
        	[<a href="${pageContext.request.contextPath}/emp/modpassword"  target="_blank">修改密码</a>]
        	[<a href="javascript:void(0);" onClick="parent.location.href='${pageContext.request.contextPath}/logout'" target="_login">注销退出</a>]&nbsp;
      </td>
      </tr>
      <tr>
