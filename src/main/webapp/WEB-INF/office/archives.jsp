...
<tr bgcolor="#E7E7E7">
	<td height="24" colspan="12" background="${pageContext.request.contextPath}/resources/skin/images/tbg.gif">&nbsp;员工档案信息列表&nbsp;</td>
</tr>
...
<tr align='center' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22" >
	...
	<td><a href="${pageContext.request.contextPath}/project-base-edit">编辑</a> | <a href="project-base-look">查看详情</a></td>
</tr>
...
<td height="28" colspan="12">
	...
	<a href="${pageContext.request.contextPath}/office/archives/archives-add" class="coolbg">&nbsp;添加档案信息&nbsp;</a>
</td>
</tr>
